    ...
    <>
      ...
      <div className="experience-container">
        ...
        <div className="experience-item">
          ...
          <p><FaBuilding /> <strong>Data Pro IT (Marketing Product & OPS)</strong>, Hyderabad, India</p>
          <p><FaClock /> August 2021 – February 2022</p>
          <ul>
        ...
        <div className="experience-item">
          ...
          <p><FaClock /> March 2022 – April 2023</p>
          <ul>
            ...
            <li><FaTasks /> Implemented data validation, monitoring, and quality assurance processes, resolving pipeline issues proactively.</li>
            <li><FaTasks /> Collaborated with domain experts to deploy scalable data solutions supporting predictive analytics and churn modeling.</li>
          </ul>
        </div>

        <div className="experience-item">
          <h3><FaBriefcase /> Software Engineer</h3>
          <p><FaBuilding /> <strong>Manas Solutions Pvt Ltd</strong>, Hyderabad, India (Remote)</p>
